...
class client:
    def __init__(self):
        ...
        self.server = Server(all_cooked_time=all_cooked_time,
    ...
    def run(self):
        ...
        while True:  # serve video forever
            ...
            # log time_stamp(s), bit_rate, buffer_size, stall_time,
            # requested chunk size, download time(ms), reward, dowloaded chunk size, dowloaded psnr, dowload msssim
